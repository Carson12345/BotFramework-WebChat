        ...
        return (
            <div className={className}>
                ...
                <label className="wc-upload" htmlFor="wc-upload-input">
                    ...
                    <svg height="20px" ><path d="M 7,1.914 7,11.707 8,11.707 8,1.914 10.146,4.061 10.854,3.354 7.5,0 4.146,3.354 4.854,4.061 z"/><path d="M 9.5,6.207 9.5,7.207 14,7.207 14,14.207 1,14.207 1,7.207 5.5,7.207 5.5,6.207 0,6.207 0,15.207 15,15.207   15,6.207 z"/></svg>
                ...
                <label className={sendButtonClassName} onClick={ () => this.onClickSend() } >
                    <div className="send-button-cus">
                        <strong className="send-button-text">Send</strong>
                    </div>
                    {/* <svg>
